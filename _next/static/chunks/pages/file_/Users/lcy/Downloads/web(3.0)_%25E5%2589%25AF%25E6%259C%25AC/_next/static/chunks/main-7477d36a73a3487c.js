(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[179], {
        ...
        t.default = function() {
            return {
                ...
                updateHead: e=>{
                    ...
                    o !== document.title && (document.title = '四川游酷'),
    ...
    5274: function(e, t, r) {
        ...
        class G extends _.default.Component {
            ...
            componentDidMount() {
                this.scrollToHash(),
                n.isSsr && (a.isFallback || a.nextExport && (x.isDynamicRoute(n.pathname) || location.search || z) || a.props && a.props.__N_SSG && (location.search || z)) && n.replace(n.pathname + "?" + String(j.assign(j.urlQueryToSearchParams(n.query), new URLSearchParams(location.search))), o, {
                    _h: 1,
        ...
        function K(e) {
            ...
            i.loadPage("/_error").then(n=>{
                ...
                return (null == u ? void 0 : u.Component) === a ? Promise.resolve().then(()=>m(r(3499))).then(n=>Promise.resolve().then(()=>m(r(5035))).then(r=>(t = r.default,
                e.App = t,
                n))).then(e=>({
        ...
        function es() {
            return (es = g(function*(e) {
                ...
                t.router = n = I.createRouter(a.page, a.query, o, {
                ...
                o.default.events.on(e, function() {
                    ...
                    if (u[a])
                        try {
                            ...
                            console.error(l.default(e) ? "".concat(e.message, "\n").concat(e.stack) : e + "")
                        }
                })
            }
            )
    ...
    3499: function(e, t, r) {
        ...
        t.default = void 0;
        var n, a = r(2648).Z, o = a(r(7294)), i = a(r(2636));
        let l = {
            400: "Bad Request",
        ...
        class $ {
            ...
            change(e, t, r, o, i) {
                ...
                return n(function*() {
                    ...
                    d._inFlightRoute && d.clc && (A || $.events.emit("routeChangeError", k(), d._inFlightRoute, U),
                    d.clc(),
                    d.clc = null),
                    r = E.addBasePath(b.addLocale(x.hasBasePath(r) ? w.removeBasePath(r) : r, o.locale, d.defaultLocale));
                    ...
                    if (!p && d.onlyAHashChange(q) && !W) {
                        ...
                        try {
                            ...
                            throw c.default(e) && e.cancelled && $.events.emit("routeChangeError", e, q, U),
                            e
                        }
                        return $.events.emit("hashChangeComplete", r, U),
                        !0
                    }
                    ...
                    if (p && ee && (j = !1),
                    j && "/_error" !== G && (o._shouldResolveHref = !0,
                    z.pathname = F(G, n),
                    z.pathname === G || (G = z.pathname,
                    ...
                    if (m.isDynamicRoute(K)) {
                        ...
                        if (et && (!o || i.result))
                            ...
                            if (e.length > 0 && !ee)
                                throw Error((o ? "The provided `href` (".concat(t, ") value is missing query values (").concat(e.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(n, ") is incompatible with the `href` value (").concat(K, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(o ? "href-interpolation-failed" : "incompatible-href-as"))
                        }
                    }
                    ...
                    try {
                        ...
                        if (p || o.shallow || (yield d._bfl(r, "resolvedAs"in l ? l.resolvedAs : void 0, C.locale)),
                        "route"in l && ee) {
                            K = G = l.route || K,
                        ...
                        if ((l.__N_SSG || l.__N_SSP) && l.props) {
                            ...
                            if (C.isPreview = !!l.props.__N_PREVIEW,
                            l.props.notFound === Z) {
                                let e;
                                try {
                        ...
                        if (p && er) {
                            ...
                            "type"in l)
                                throw Error("Unexpected middleware effect on ".concat(d.pathname));
                        ...
                        if (!S) {
                            ...
                            if (l.error)
                                throw p || $.events.emit("routeChangeError", l.error, q, U),
                                l.error;
            ...
            handleRouteInfoError(e, t, r, a, o, i) {
                ...
                return n(function*() {
                    ...
                    if (s.isAssetError(e) || i)
                        throw $.events.emit("routeChangeError", e, a, o),
                        X({
                            url: a,
                            router: l
                        }),
            ...
            getRouteInfo(e) {
                let {route: t, pathname: r, query: o, as: i, resolvedAs: s, routeProps: u, locale: d, hasMiddleware: p, isPreview: h, unstable_skipClientCache: m, isQueryUpdating: g, isMiddlewareRewrite: y, isNotFound: v} = e;
                var P = this;
                return n(function*() {
                    let e = t;
                    try {
                        ...
                        t(),
                        (null == R ? void 0 : null == (b = R.effect) ? void 0 : b.type) === "redirect-internal" || (null == R ? void 0 : null == (S = R.effect) ? void 0 : S.type) === "redirect-external")
                            return R.effect;
                        if ((null == R ? void 0 : null == (E = R.effect) ? void 0 : E.type) === "rewrite") {
                            ...
                            s = w.removeBasePath(f.normalizeLocalePath(R.effect.parsedAs.pathname, P.locales).pathname),
                            c = P.components[e],
                        ...
                        let {props: T, cacheKey: I} = yield P._getData(n(function*() {
                            if (L) {
                        ...
                        return M.__N_SSP && O.dataHref && I && delete P.sdc[I],
                        P.isPreview || !M.__N_SSG || g || G(Object.assign({}, O, {
                            isBackground: !0,
                            persistCache: !1,
                            inflightCache: P.sbc
                        })).catch(()=>{}
            ...
            prefetch(e) {
                ...
                return n(function*() {
                    ...
                    n.pathname = i,
                    Object.assign(s, y.getRouteMatcher(v.getRouteRegex(n.pathname))(P.parsePath(t).pathname) || {}),
            ...
            constructor(e, t, r, {initialProps: n, pageLoader: a, App: o, wrapApp: i, Component: s, err: u, subscription: c, isFallback: d, locale: f, locales: p, defaultLocale: y, domainLocales: v, isPreview: P}) {
                this.sdc = {},
                this.sbc = {},
    ...
    8018: function(e) {
        ...
        O = function(e) {
            if (e.cancelable) {
                ...
                addEventListener("pointercancel", r, E)) : j(a, e)
            }
        }
        ,
        R = function(e) {
